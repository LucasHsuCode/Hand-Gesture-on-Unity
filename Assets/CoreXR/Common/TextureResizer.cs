    ...
    public class TextureResizer : System.IDisposable
    {
        ...
        public Material material
        {
            get
            {
                ...
                {
                    _blitMaterial = new Material(Shader.Find("Hidden/Resize"));
                }
        ...
        public RenderTexture Resize(Texture texture, int width, int height, bool fillBackground, Matrix4x4 transform, Vector4 uvRect)
        {
