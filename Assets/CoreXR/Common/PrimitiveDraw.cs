...
{
    /**
     * \brief PrimitiveDraw is a simple drawing utility in Unity
     */
    public sealed class PrimitiveDraw : System.IDisposable
    {
        ...
        /** \brief The getter and setter variable to change PrimitiveDraw color */
        public Color color
        {
        ...
        /**
         * \brief The default constructor for PrimitiveDraw.
         * @param camera The camera in unity.
         * @param layer  The layer in unity.
         */
        ...
        /**
         * \brief The function must be called when PrimitiveDrawy will be destroyed.
         */
        public void Dispose()
        {
        ...
        /**
         * \brief The function to clear the previous rendering.
         */
        public void Clear()
        {
            cube.Clear();
        ...
        /**
         * \brief The function to actually apply all previous rendering calls.
         */
        ...
        /**
         * \brief The rendering function to draw 2D line.
        ...
        /**
         * \brief The rendering function to draw rect.
         * @param rect      The target rect
         * @param thickness The thickness of line
         * @param z         The fake value on z-axis
         */
        ...
        /**
         * \brief The rendering function to draw point.
         * @param p         The target point
         * @param thickness The thickness of point
         */
        ...
        /**
         * \brief The rendering function to draw 3D line.
         * @param start     The start point
         * @param end       The end point
         * @param thickness The thickness of line
         */
        ...
        /**
         * \brief The rendering function to draw cube.
         * @param center  The center of cube
        ...
        /**
         * \brief The rendering function to draw quad.
         * @param a         The first point of quad
         * @param b         The second point of quad
         * @param c         The third point of quad
         * @param d         The fourth point of quad
         * @param thickness The size of cube
         */
